...
def mainScenario2(info=1):
    ...
    """
    log_com_1, log_goal_1, log_end_effector_1 = scenario2(robot_urdf_path="urdf/sassa-robot/robot.urdf", robot_file_path="urdf/sassa-robot/", enable_viz=False)
    log_com_2, log_goal_2, log_end_effector_2 = scenario2(robot_urdf_path="urdf/sassa-robot-short-arm/robot.urdf", robot_file_path="urdf/sassa-robot-short-arm/", enable_viz=False)
    ...
    if info == 1:
        ...
        # log test 1
        # Velocity erroro of the end effector
        fig = plt.figure()
